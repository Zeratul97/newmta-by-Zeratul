...
addEventHandler("infobox", root,
	function(message, itype) 
		createInfoBox(message, itype, playSound("files/sounds/"..itype..".mp3"))
	end
)
...
function createInfoBox(message, itype)
	...
	playSound("files/sounds/"..itype..".mp3")
...
-- Kliens oldali meghívás --
--exports["nwmta_infobox"]:createInfoBox("Működik", "info")

-- Szerver oldali meghívás --
--triggerClientEvent(root, "infobox", root, getElementData(player, "admin:nev").." adminszolgálatba lépett!", "info") -- Mindenki látja
--triggerClientEvent(player, "infobox", player, getElementData(player, "admin:nev").." adminszolgálatba lépett!", "info") -- Csak az adott játékos láthatja
